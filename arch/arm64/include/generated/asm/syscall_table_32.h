...
__SYSCALL_WITH_COMPAT(119, sys_sigreturn_wrapper, compat_sys_sigreturn)
...
__SYSCALL_WITH_COMPAT(173, sys_rt_sigreturn_wrapper, compat_sys_rt_sigreturn)
...
__SYSCALL_WITH_COMPAT(180, sys_pread64, compat_sys_aarch32_pread64)
__SYSCALL_WITH_COMPAT(181, sys_pwrite64, compat_sys_aarch32_pwrite64)
...
__SYSCALL_WITH_COMPAT(192, sys_mmap2, compat_sys_aarch32_mmap2)
__SYSCALL_WITH_COMPAT(193, sys_truncate64, compat_sys_aarch32_truncate64)
__SYSCALL_WITH_COMPAT(194, sys_ftruncate64, compat_sys_aarch32_ftruncate64)
...
__SYSCALL_WITH_COMPAT(225, sys_readahead, compat_sys_aarch32_readahead)
...
__SYSCALL_WITH_COMPAT(243, sys_io_setup, compat_sys_io_setup)
__SYSCALL(244, sys_io_destroy)
__SYSCALL(245, sys_io_getevents_time32)
__SYSCALL_WITH_COMPAT(246, sys_io_submit, compat_sys_io_submit)
...
__SYSCALL_WITH_COMPAT(266, sys_statfs64_wrapper, compat_sys_aarch32_statfs64)
__SYSCALL_WITH_COMPAT(267, sys_fstatfs64_wrapper, compat_sys_aarch32_fstatfs64)
__SYSCALL(268, sys_tgkill)
__SYSCALL(269, sys_utimes_time32)
__SYSCALL_WITH_COMPAT(270, sys_arm_fadvise64_64, compat_sys_aarch32_fadvise64_64)
__SYSCALL(271, sys_pciconfig_iobase)
__SYSCALL(272, sys_pciconfig_read)
__SYSCALL(273, sys_pciconfig_write)
__SYSCALL_WITH_COMPAT(274, sys_mq_open, compat_sys_mq_open)
__SYSCALL(275, sys_mq_unlink)
__SYSCALL(276, sys_mq_timedsend_time32)
__SYSCALL(277, sys_mq_timedreceive_time32)
__SYSCALL_WITH_COMPAT(278, sys_mq_notify, compat_sys_mq_notify)
__SYSCALL_WITH_COMPAT(279, sys_mq_getsetattr, compat_sys_mq_getsetattr)
__SYSCALL_WITH_COMPAT(280, sys_waitid, compat_sys_waitid)
...
__SYSCALL_WITH_COMPAT(291, sys_recv, compat_sys_recv)
__SYSCALL_WITH_COMPAT(292, sys_recvfrom, compat_sys_recvfrom)
__SYSCALL(293, sys_shutdown)
__SYSCALL(294, sys_setsockopt)
__SYSCALL(295, sys_getsockopt)
__SYSCALL_WITH_COMPAT(296, sys_sendmsg, compat_sys_sendmsg)
__SYSCALL_WITH_COMPAT(297, sys_recvmsg, compat_sys_recvmsg)
__SYSCALL(298, sys_semop)
__SYSCALL(299, sys_semget)
__SYSCALL_WITH_COMPAT(300, sys_old_semctl, compat_sys_old_semctl)
__SYSCALL_WITH_COMPAT(301, sys_msgsnd, compat_sys_msgsnd)
__SYSCALL_WITH_COMPAT(302, sys_msgrcv, compat_sys_msgrcv)
__SYSCALL(303, sys_msgget)
__SYSCALL_WITH_COMPAT(304, sys_old_msgctl, compat_sys_old_msgctl)
__SYSCALL_WITH_COMPAT(305, sys_shmat, compat_sys_shmat)
__SYSCALL(306, sys_shmdt)
__SYSCALL(307, sys_shmget)
__SYSCALL_WITH_COMPAT(308, sys_old_shmctl, compat_sys_old_shmctl)
__SYSCALL(309, sys_add_key)
__SYSCALL(310, sys_request_key)
__SYSCALL_WITH_COMPAT(311, sys_keyctl, compat_sys_keyctl)
__SYSCALL(312, sys_semtimedop_time32)
...
__SYSCALL(319, sys_mbind)
__SYSCALL(320, sys_get_mempolicy)
__SYSCALL(321, sys_set_mempolicy)
__SYSCALL_WITH_COMPAT(322, sys_openat, compat_sys_openat)
__SYSCALL(323, sys_mkdirat)
__SYSCALL(324, sys_mknodat)
__SYSCALL(325, sys_fchownat)
__SYSCALL(326, sys_futimesat_time32)
...
__SYSCALL_WITH_COMPAT(335, sys_pselect6_time32, compat_sys_pselect6_time32)
__SYSCALL_WITH_COMPAT(336, sys_ppoll_time32, compat_sys_ppoll_time32)
__SYSCALL(337, sys_unshare)
__SYSCALL_WITH_COMPAT(338, sys_set_robust_list, compat_sys_set_robust_list)
__SYSCALL_WITH_COMPAT(339, sys_get_robust_list, compat_sys_get_robust_list)
__SYSCALL(340, sys_splice)
__SYSCALL_WITH_COMPAT(341, sys_sync_file_range2, compat_sys_aarch32_sync_file_range2)
__SYSCALL(342, sys_tee)
__SYSCALL(343, sys_vmsplice)
__SYSCALL(344, sys_move_pages)
__SYSCALL(345, sys_getcpu)
__SYSCALL_WITH_COMPAT(346, sys_epoll_pwait, compat_sys_epoll_pwait)
__SYSCALL_WITH_COMPAT(347, sys_kexec_load, compat_sys_kexec_load)
__SYSCALL(348, sys_utimensat_time32)
__SYSCALL_WITH_COMPAT(349, sys_signalfd, compat_sys_signalfd)
__SYSCALL(350, sys_timerfd_create)
__SYSCALL(351, sys_eventfd)
__SYSCALL_WITH_COMPAT(352, sys_fallocate, compat_sys_aarch32_fallocate)
__SYSCALL(353, sys_timerfd_settime32)
__SYSCALL(354, sys_timerfd_gettime32)
__SYSCALL_WITH_COMPAT(355, sys_signalfd4, compat_sys_signalfd4)
...
__SYSCALL_WITH_COMPAT(361, sys_preadv, compat_sys_preadv)
__SYSCALL_WITH_COMPAT(362, sys_pwritev, compat_sys_pwritev)
__SYSCALL_WITH_COMPAT(363, sys_rt_tgsigqueueinfo, compat_sys_rt_tgsigqueueinfo)
__SYSCALL(364, sys_perf_event_open)
__SYSCALL_WITH_COMPAT(365, sys_recvmmsg_time32, compat_sys_recvmmsg_time32)
__SYSCALL(366, sys_accept4)
__SYSCALL(367, sys_fanotify_init)
__SYSCALL_WITH_COMPAT(368, sys_fanotify_mark, compat_sys_fanotify_mark)
__SYSCALL(369, sys_prlimit64)
__SYSCALL(370, sys_name_to_handle_at)
__SYSCALL_WITH_COMPAT(371, sys_open_by_handle_at, compat_sys_open_by_handle_at)
__SYSCALL(372, sys_clock_adjtime32)
__SYSCALL(373, sys_syncfs)
__SYSCALL_WITH_COMPAT(374, sys_sendmmsg, compat_sys_sendmmsg)
__SYSCALL(375, sys_setns)
__SYSCALL(376, sys_process_vm_readv)
__SYSCALL(377, sys_process_vm_writev)
...
__SYSCALL(386, sys_bpf)
__SYSCALL_WITH_COMPAT(387, sys_execveat, compat_sys_execveat)
__SYSCALL(388, sys_userfaultfd)
__SYSCALL(389, sys_membarrier)
__SYSCALL(390, sys_mlock2)
__SYSCALL(391, sys_copy_file_range)
__SYSCALL_WITH_COMPAT(392, sys_preadv2, compat_sys_preadv2)
__SYSCALL_WITH_COMPAT(393, sys_pwritev2, compat_sys_pwritev2)
__SYSCALL(394, sys_pkey_mprotect)
__SYSCALL(395, sys_pkey_alloc)
__SYSCALL(396, sys_pkey_free)
__SYSCALL(397, sys_statx)
__SYSCALL(398, sys_rseq)
__SYSCALL_WITH_COMPAT(399, sys_io_pgetevents_time32, compat_sys_io_pgetevents)
__SYSCALL(400, sys_migrate_pages)
__SYSCALL(401, sys_kexec_file_load)
