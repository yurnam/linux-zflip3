...
.ascii "->TRAMP_VALIAS -4398082211840 TRAMP_VALIAS"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:181:   DEFINE(SDEI_EVENT_INTREGS,	offsetof(struct sdei_registered_event, interrupted_regs));
// 181 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->SDEI_EVENT_INTREGS 0 offsetof(struct sdei_registered_event, interrupted_regs)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:182:   DEFINE(SDEI_EVENT_PRIORITY,	offsetof(struct sdei_registered_event, priority));
// 182 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->SDEI_EVENT_PRIORITY 356 offsetof(struct sdei_registered_event, priority)"	//
// 0 "" 2
