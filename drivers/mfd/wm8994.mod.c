...
KSYMTAB_FUNC(wm8994_irq_init, "", "");
KSYMTAB_FUNC(wm8994_irq_exit, "", "");
KSYMTAB_DATA(wm1811_regmap_config, "", "");
KSYMTAB_DATA(wm8994_regmap_config, "", "");
KSYMTAB_DATA(wm8958_regmap_config, "", "");
KSYMTAB_DATA(wm8994_base_regmap_config, "", "");
