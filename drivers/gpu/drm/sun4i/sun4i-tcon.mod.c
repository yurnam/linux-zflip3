...
KSYMTAB_FUNC(sun4i_dclk_create, "", "");
KSYMTAB_FUNC(sun4i_dclk_free, "", "");
KSYMTAB_FUNC(sun4i_lvds_init, "", "");
KSYMTAB_FUNC(sun4i_tcon_enable_vblank, "", "");
KSYMTAB_FUNC(sun4i_tcon_mode_set, "", "");
KSYMTAB_DATA(sun4i_tcon_of_table, "", "");
KSYMTAB_FUNC(sun4i_rgb_init, "", "");
