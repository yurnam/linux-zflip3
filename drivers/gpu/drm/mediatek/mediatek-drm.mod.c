...
MODULE_ALIAS("of:N*T*Cmediatek,mt8188-dsi");
MODULE_ALIAS("of:N*T*Cmediatek,mt8188-dsiC*");
...
MODULE_ALIAS("of:N*T*Cmediatek,mt8195-disp-gamma");
MODULE_ALIAS("of:N*T*Cmediatek,mt8195-disp-gammaC*");
