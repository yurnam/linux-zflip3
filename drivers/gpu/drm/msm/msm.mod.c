...
MODULE_INFO(depends, "drm_display_helper,gpu-sched,ocmem,llcc-qcom,drm_dp_aux_bus,mdt_loader");
...
MODULE_ALIAS("of:N*T*Cqcom,sm6125-dpu");
MODULE_ALIAS("of:N*T*Cqcom,sm6125-dpuC*");
MODULE_ALIAS("of:N*T*Cqcom,sm6350-dpu");
MODULE_ALIAS("of:N*T*Cqcom,sm6350-dpuC*");
MODULE_ALIAS("of:N*T*Cqcom,sm6375-dpu");
MODULE_ALIAS("of:N*T*Cqcom,sm6375-dpuC*");
...
MODULE_ALIAS("of:N*T*Cqcom,sm6125-mdss");
MODULE_ALIAS("of:N*T*Cqcom,sm6125-mdssC*");
MODULE_ALIAS("of:N*T*Cqcom,sm6350-mdss");
MODULE_ALIAS("of:N*T*Cqcom,sm6350-mdssC*");
MODULE_ALIAS("of:N*T*Cqcom,sm6375-mdss");
MODULE_ALIAS("of:N*T*Cqcom,sm6375-mdssC*");
