...
KSYMTAB_FUNC(rcar_lvds_pclk_enable, "_gpl", "");
KSYMTAB_FUNC(rcar_lvds_pclk_disable, "_gpl", "");
KSYMTAB_FUNC(rcar_lvds_dual_link, "_gpl", "");
KSYMTAB_FUNC(rcar_lvds_is_connected, "_gpl", "");
